...
[docs]def jwt_required(realm=None):
...
[docs]    def authentication_handler(self, callback):
...
[docs]    def identity_handler(self, callback):
...
[docs]    def jwt_error_handler(self, callback):
...
[docs]    def auth_response_handler(self, callback):
...
[docs]    def auth_request_handler(self, callback):
        """Specifies the authentication response handler function.
...
[docs]    def request_handler(self, callback):
...
[docs]    def jwt_encode_handler(self, callback):
...
[docs]    def jwt_decode_handler(self, callback):
...
[docs]    def jwt_payload_handler(self, callback):
...
[docs]    def jwt_headers_handler(self, callback):
